`timescale 1ns/1ps
module tb_mlkem_secure_channel_axi_top;
    ...
    mlkem_secure_channel_axi_top dut(clk,rst,aw,awv,awr,wd,ws,wv,wr,bp,bv,br,
    ...
    initial begin aw=0;ar=0;awv=0;wv=0;br=0;arv=0;rr=0;wd=0;ws=15;
        ...
        if(!status[2]||status[3])$fatal(1,"AXI Decaps/session status %h",status);
        ...
        if(!sauth[0]||serr[0]||sdata[511:0]!==pack64(512'hb7b235da3dbbb9ecd92eca9019e9223a368ca0aad5fd167f9c86595d727381cb0ecf98c4fd286c963ffe346c8644bd72386083ca105e9f23cdbc2697877d85fa)
          ||stag[127:0]!==pack16(128'h0b8552e36371bcd72ab7f0aba138952c))$fatal(1,"automatic AEAD slot install");
        $display("ALL ML-KEM AXI-LITE TO AEAD SESSION TESTS PASSED");$finish;
    end
    initial begin #100000000;$fatal(1,"AXI secure channel timeout");end
endmodule
