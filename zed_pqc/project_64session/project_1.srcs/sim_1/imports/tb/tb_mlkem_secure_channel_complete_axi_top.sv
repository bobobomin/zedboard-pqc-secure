...
module tb_mlkem_secure_channel_complete_axi_top;
  ...
  always @(posedge clk) begin
    if (!rst) begin
      ...
      /*
       * ML-KEM AXI START가 내부 launch pulse로 변환된 시점부터 측정
       */
      ...
      if (profile_running) begin
        ...
        /*
         * K-PKE decrypt 쪽 polynomial accelerator
         */
        ...
        /*
         * K-PKE re-encryption 쪽 polynomial accelerator
         */
